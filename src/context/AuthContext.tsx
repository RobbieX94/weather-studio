...
interface AuthContextType {
  ...
  // studio        → igual que freelance_pro + alertas automáticas + historial PDF
  ...
  canExportDayPDF: () => boolean   // PDF hora a hora (freelance_pro+)
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  async function updateProfile(data: Partial<Omit<AuthUser, 'id' | 'email'>>) {
    if (!user) return
