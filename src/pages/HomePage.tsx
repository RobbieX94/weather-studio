        ...
        <div style={{ position: 'relative', maxWidth: 1280, margin: '0 auto', padding: '148px 24px 96px' }}>
          <div style={{ display: 'grid', gap: 48, alignItems: 'center', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }}>
            <div>
              ...
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.05 }} style={{ maxWidth: 760, fontSize: 'clamp(2.5rem,6vw,4.6rem)', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-0.03em', color: '#fff', textShadow: '0 10px 30px rgba(0,0,0,0.18)' }}>
                Planifica tus rodajes con meteorología <span style={{ color: '#8feaff' }}>útil de verdad</span>
              </motion.h1>

              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} style={{ marginTop: 24, maxWidth: 720, fontSize: 18, lineHeight: 1.8, color: 'rgba(226,232,240,0.94)' }}>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }} style={{ marginTop: 32, display: 'flex', flexWrap: 'wrap', gap: 12 }}>
                <button onClick={() => navigate('/register?plan=free')} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 18, background: '#22d3ee', padding: '14px 24px', fontSize: 16, fontWeight: 700, color: '#082f49', border: 'none', cursor: 'pointer', boxShadow: '0 16px 40px rgba(34,211,238,0.18)' }}>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.96, y: 16 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.15 }} style={{ position: 'relative' }}>
              <div style={{ position: 'absolute', inset: -16, borderRadius: 32, background: 'rgba(34,211,238,0.07)', filter: 'blur(40px)' }} />
              <div style={{ position: 'relative', borderRadius: 28, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(2,6,23,0.44)', padding: 16, boxShadow: '0 24px 80px rgba(0,0,0,0.24)', backdropFilter: 'blur(14px)' }}>
